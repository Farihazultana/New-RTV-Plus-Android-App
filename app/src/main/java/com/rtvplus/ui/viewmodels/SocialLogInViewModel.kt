...
@HiltViewModel
class SocialLogInViewModel @Inject constructor(private val repository: GoogleLogInRepository):ViewModel(){
    ...
    fun fetchSocialLogInData(logintype: String, source: String, username: String, password: String, firstName: String, lastName: String, email: String, imgUrl: String){
